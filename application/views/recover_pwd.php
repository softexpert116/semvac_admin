				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						<div class="alert alert-info">
							<p class="m-none text-semibold h6">Enter your user ID below and we will send you reset instructions!</p>
						</div>

						<form action="#" method="post">
							<div class="form-group mb-none">
								<div class="input-group">
									<input name="userid" type="text" placeholder="UserID" class="form-control input-lg" />
							...
							<p class="text-center mt-lg">Remembered? <a href="<?php echo base_url();?>index.php/signin">Sign In!</a>
						</form>
					</div>
				</div>
