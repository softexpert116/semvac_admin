		...
		<section class="body-sign">
			<div class="center-sign">
				<a href="#" class="logo pull-left">
					...
					<p style="font-size: 35px; font-family: fantasy; font-weight: bold;">Admin Panel</p>
				</a>
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						...
						<?php } ?>
						<form action="<?php echo base_url();?>index.php/signin/do_signin" method="post">
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="checkbox-custom checkbox-default" style="visibility: hidden;">
