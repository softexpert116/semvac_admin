															...
															<footer class="panel-footer">
																<div class="row">
																	<div class="col-md-12 text-right">
																		<a class="btn btn-primary" href="<?php echo base_url().'index.php/user/delete_item/tbl_account/'.$data[$i]['id']; ?>" >Confirm</a>
...
(function( $ ) {
	...
	$('#edit_picker').datepicker({
        ...
        $("#add_button").click(function() {
            ...
            $.ajax({url: "<?php echo base_url(); ?>index.php/user/add_account", data:data, type:'POST', success: function(result){
                if (result == 200) {
                    // window.history.go(0);
                    location.reload();
                } else if (result == 400) {
        ...
        $("#edit_button").click(function() {
            ...
            $.ajax({url: "<?php echo base_url(); ?>index.php/user/edit_account", data:data, type:'POST', success: function(result){
                if (result == 200) {
                    // window.history.go(0);
                    location.reload();                    
                } else if (result == 400) {
