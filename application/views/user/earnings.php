															...
															<footer class="panel-footer">
																<div class="row">
																	<div class="col-md-12 text-right">
																		<a class="btn btn-primary" href="<?php echo base_url().'index.php/user/delete_item/tbl_earning/'.$data[$i]['id']; ?>" >Confirm</a>
...
(function( $ ) {
	...
	$('#edit_date').datepicker({
        ...
        $("#add_button").click(function() {
            ...
            $("#add_warning").hide();
            var data = {'payment_email':payment_email, 'task':task, 'amount':amount, 'date':date};
            $.ajax({url: "<?php echo base_url(); ?>index.php/user/add_earning", data:data, type:'POST', success: function(result){
                if (result == 200) {
                    // window.history.go(0);
                    location.reload();
                } else if (result == 400) {
        ...
        $("#edit_button").click(function() {
            ...
            $("#edit_warning").hide();
            var data = {'id':id, 'payment_email':payment_email, 'amount':amount, 'task':task, 'date':date};
            $.ajax({url: "<?php echo base_url(); ?>index.php/user/edit_earning", data:data, type:'POST', success: function(result){
                if (result == 200) {
                    // window.history.go(0);
                    location.reload();                    
                } else if (result == 400) {
