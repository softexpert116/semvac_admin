...
<!-- 					<img src="assets/images/logo.png" height="54" alt="Porto Admin" /> -->
				...
				<div class="panel panel-sign">
					...
					<div class="panel-body">
						...
						<?php } ?>
						<form method="post" action="<?php echo base_url();?>index.php/signin/do_signup">
							...
							<p class="text-center">Already have an account? <a href="<?php echo base_url();?>index.php/signin">Sign In!</a>
